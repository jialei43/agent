...
server_url = "http://192.168.23.77:8001/mcp"
...
async def run_agent():
    ...
    async with streamablehttp_client(url=server_url) as (read, write, function):
        # async with streamablehttp_client(url=server_url) as (read, write):
        # 使用读写通道创建 MCP 会话
